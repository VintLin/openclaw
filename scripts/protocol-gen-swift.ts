...
function emitStruct(name: string, schema: JsonSchema): string {
  ...
  const sortedProps = Object.entries(props).toSorted(([a], [b]) => a.localeCompare(b));
  ...
  for (const [key, propSchema] of sortedProps) {
...
async function generate() {
  const definitions = Object.entries(ProtocolSchemas).toSorted(([a], [b]) =>
    a.localeCompare(b),
